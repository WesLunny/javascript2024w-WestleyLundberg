...
*/
let array_insertX = ["Donald Trump", "Jackie Chan","Santa Claus"]; 
let array_insertY = ["Area 51", "Death Valley","Aruba"];
let array_insertZ = ["spontaneously Combusted", "Rapidly Sublimated","Evaporated Instantly"];
...
function result() {
    ...
    var xItem = randomValueFromArray(array_insertX);
    var yItem = randomValueFromArray(array_insertY);
    var zItem = randomValueFromArray(array_insertZ);
    //console.log(xItem);
